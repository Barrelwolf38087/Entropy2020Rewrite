...
public class Storage extends SubsystemBase {
  ...
  private final int ROLLER_BOTTOM_PORT = Constants.STORAGE_BOTTOM;
  private final int ROLLER_TOP_PORT = Constants.STORAGE_TOP;

  private final int STORAGE_CAPICTY = 5;

  private final double STORE_SPEED = 0.5;
//    Config.getInstance().getDouble(Key.STORAGE__ROLLER_STORE_SPEED);
  private final double BOTTOM_SPEED_FACTOR = 1.1;
//    Config.getInstance().getDouble(Key.STORAGE__ROLLER_BOTTOM_SPEED_FACTOR);
  private final double TEST_SPEED_FACTOR = 0.5;
//    Config.getInstance().getDouble(Key.STORAGE__ROLLER_SPEED_FACTOR);
  private final double EJECT_SPEED = 0.4;
...
//    } else {
    BALL_DISTANCE_IN_ENCODER_TICKS = 260;
